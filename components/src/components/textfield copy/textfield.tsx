...
export class Textfield {
  ...
  reflectedInput: HTMLInputElement;
  ...
  handleInput(e): void {
    ...
    this.reflectedInput.value = this.value;
  }
  ...
  componentWillLoad() {
    this.reflectedInput = document.createElement('input');
    this.reflectedInput.style.display = 'none';

    this.reflectedInput.setAttribute('name', this.name);
    this.reflectedInput.setAttribute('id', this.id);

    this.host.parentElement.appendChild(this.reflectedInput);
  }
